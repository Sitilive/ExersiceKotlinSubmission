 ...
 */
fun myProfile() {
    val firstName: String = "Siti"
    val lastName: String =  "Nurhidayah"
    val age: Int = 22
...
groupMember: List<Any>, session: String): Any {
 ...
 */
fun myName(): String {
    val dftNameTim = arrayOf("Siti", "Mona", "Zainul", "Lumban", "Thomi")
    return "Siti"
}
...
fun main() {
     ...
     *
     */
    groupDetail(7, listOf("Lumban", "Zainul", "Thomi", "Monalisa", "Siti"), "Afternoon")
